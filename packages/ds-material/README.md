...
[![npm (scoped)](https://img.shields.io/npm/v/@xy-form/ds-material?style=flat-square)](https://www.npmjs.com/package/@xy-form/ds-material)
[![MIT license](https://img.shields.io/npm/l/@xy-form/ds-material?style=flat-square)](https://github.com/ui-schema/ui-schema/blob/master/LICENSE)
![Typed](https://flat.badgen.net/badge/icon/Typed?icon=typescript&label&labelColor=blue&color=555555)

[Material Design](https://material.io) binding to work with [@xy-form/ui-schema](https://github.com/ui-schema/ui-schema), using [@mui](https://github.com/mui-org/material-ui/) to generate UI and forms out of JSON Schema.
