...
[![npm (scoped)](https://img.shields.io/npm/v/@xy-form/pro?style=flat-square)](https://www.npmjs.com/package/@xy-form/pro)
[![MIT license](https://img.shields.io/npm/l/@xy-form/pro?style=flat-square)](https://github.com/ui-schema/pro/blob/master/LICENSE)
