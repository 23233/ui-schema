...
[![npm (scoped)](https://img.shields.io/npm/v/@xy-form/ds-bootstrap?style=flat-square)](https://www.npmjs.com/package/@xy-form/ds-bootstrap)
[![MIT license](https://img.shields.io/npm/l/@xy-form/ds-bootstrap?style=flat-square)](https://github.com/ui-schema/ui-schema/blob/master/LICENSE)
![Typed](https://flat.badgen.net/badge/icon/Typed?icon=typescript&label&labelColor=blue&color=555555)

[Bootstrap](https://getbootstrap.com/) binding to work with [@xy-form/ui-schema](https://github.com/ui-schema/ui-schema), using native HTML and bootstrap semantics to generate UI and forms out of JSON Schema.
